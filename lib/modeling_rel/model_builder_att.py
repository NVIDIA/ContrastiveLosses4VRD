...
import modeling_rel.fast_rcnn_heads_rel as fast_rcnn_heads
...
class Generalized_RCNN(nn.Module):
    ...
    def _forward(self, data, im_info, dataset_name=None, roidb=None, **rpn_kwargs):
        ...
        att_cls_scores = self.AttDN(att_feat, att_ret['all_obj_labels_int32'])  # all_obj_labels_int32 start from 0
