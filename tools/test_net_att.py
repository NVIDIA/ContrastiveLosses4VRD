...
#         cfg.MODEL.NUM_ATT_CLASSES = 617  # att, exclude background
        ...
        cfg.TEST.DATASETS = ('gqa_no_plural_adj_only_val',)
        cfg.MODEL.NUM_CLASSES = 1321
        cfg.MODEL.NUM_ATT_CLASSES = 445  # att, exclude background
    elif args.dataset == "gqa_no_plural_adj_only_all":
        cfg.TEST.DATASETS = ('gqa_no_plural_adj_only_all',)
        cfg.MODEL.NUM_CLASSES = 1321
        cfg.MODEL.NUM_ATT_CLASSES = 445  # att, exclude background
    elif args.dataset == "gqa_no_plural_no_adj":
        cfg.TEST.DATASETS = ('gqa_no_plural_no_adj_val',)
        cfg.MODEL.NUM_CLASSES = 1321
        cfg.MODEL.NUM_ATT_CLASSES = 172  # att, exclude background
    elif args.dataset == "gqa_no_plural_no_adj_all":
        cfg.TEST.DATASETS = ('gqa_no_plural_no_adj_all',)
        cfg.MODEL.NUM_CLASSES = 1321
        cfg.MODEL.NUM_ATT_CLASSES = 172  # att, exclude background
